...
# Your name: Nolan Schmitt  
# Your student id: 00172338
# Your email: nolansc@umich.edu
...
def make_players_table(data, cur, conn):
    ...
    for player in data['squad']:
        ...
        cur.execute("""
            INSERT OR IGNORE INTO Players (id, name, position_id, birthyear, nationality)
            VALUES (?, ?, ?, ?, ?)
...
def birthyear_nationality_search(age, country, cur, conn):
    ...
    cur.execute(query, (country, latest_birthyear))
    result = cur.fetchall()
...
def position_birth_search(position, age, cur, conn):
    ...
    cur.execute(query, (position, earliest_birthyear))
    result = cur.fetchall()
